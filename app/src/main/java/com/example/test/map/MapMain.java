 ...
 */
public class MapMain extends RosAppActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        refreshButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // TODO
                Toast.makeText(MapMain.this, "refreshing map...",
                ...
                nameField.setOnKeyListener(new View.OnKeyListener() {
                    ...
                    public boolean onKey(final View view, int keyCode,
                        ...
                        if (event.getAction() == KeyEvent.ACTION_DOWN
                            ...
                            try {
                                final MapManager mapManager = new MapManager(MapMain.this, remaps);
    ...
    private void safeShowWaitingDialog(final CharSequence message) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                waitingDialog = ProgressDialog.show(MapMain.this, "",
                        message, true);
            }
        });
    }
